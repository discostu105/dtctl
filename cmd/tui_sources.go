...
// tuiSources wires the TUI's API-backed views (catalog.Spec.API) to the
// existing resource handlers. All sources are read-only; construction here
// keeps pkg/tui free of HTTP, mirroring how cmd/tui.go passes the DQL
// executor.
