module github.com/dynatrace-oss/dtui

go 1.26.4

replace github.com/dynatrace-oss/dtctl => ../
...
require (
	...
	github.com/dynatrace-oss/dtctl/sdk v0.0.0-00010101000000-000000000000 // indirect
