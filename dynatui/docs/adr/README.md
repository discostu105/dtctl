...
Short records of the decisions that shaped dynatui, in the spirit of
...
| [0004](0004-separate-module-and-binary.md) | dynatui is a separate Go module and binary; `dtctl tui` forwards |
| [0005](0005-dtctl-owns-configuration.md) | dtctl owns configuration; dynatui is a pure consumer |
...
| [0011](0011-strictly-read-only.md) | dynatui is strictly read-only; mutations are not planned |
| [0012](0012-navigate-analyze-mutate.md) | Navigate in dynatui, analyze in the web UI, mutate via dtctl |
