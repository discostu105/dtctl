# ADR-0012: Navigate in dynatui, analyze in the web UI, mutate via dtctl
...
Three verbs, three tools. **dynatui owns navigate and explore**: seeing what
...
dynatui is the navigation layer between the CLI and the web, and its job ends
