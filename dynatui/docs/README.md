...
- **[design/](design/)** — what dynatui is and how it's built
  - [vision.md](design/vision.md) — the vision & scope charter: who dynatui
...
[DYNATUI_SPLIT_DESIGN.md](../../docs/dev/DYNATUI_SPLIT_DESIGN.md); the shared
