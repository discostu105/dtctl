...
// disablePreview turns one app's peek pane off: navigator tests stay
// synchronous (no debounce ticks) and table tests measure the bare table.
func disablePreview(a *app) {
